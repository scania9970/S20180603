...
function submitChk(){
	if("${member}"){
		location.href="/cota/groupWriteForm";
	}else{
           ...
           <div class="row">
           	...
           	<table class="table table-bordered">
	               <tr style="text-align:center;">
	                   <th>번호</th><th>제목</th><th>작성자</th><th>상태</th><th>날짜</th>
	               </tr>
	               <c:forEach var="post" items="${posts }">
	               <tr>
	                   <td>${post.bnum }</td>
	                   <td><a href="/cota/viewGroupPost?bnum=${post.bnum}">${post.title }</a></td>
	                   <td>${post.nickname }</td>
	                   <c:if test="${post.join_status == 1 }">
	                       <td style="text-align:center;">
	                       	<span class="label label-danger" style="font-size: 15px;">마감</span>
	                       </td>
	                   </c:if>
	                   <c:if test="${post.join_status == 0 }">
	                       <td style="text-align:center;">
	                       	<span class="label label-primary" style="font-size: 15px;">모집</span>
	                       </td>
	                   </c:if>

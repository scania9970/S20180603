...
<div class="row">
    ...
    <div class="container-fluid">
        ...
        <h1>소모임 & 스터디</h1>
           ...
           <div class='row'>
				<div class="col-lg-8">
					<form action="/cota/udpateGroupPost">
					<input type="hidden" name="email" value="${member.email }">
					<input type="hidden" name="bnum" value="${post.bnum }">
					  <div class="input-group" style="margin-bottom: 10px;">
					    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
					    <input id="email" type="text" class="form-control" name="title" placeholder="TITLE" value="${post.title }">
					  </div>
					  <div class="input-group">
					    <span class="input-group-addon"><span class="glyphicon glyphicon-list-alt"></span></span>
					    <textarea class="form-control" rows="28" placeholder="CONTENT" name="content">${post.content }</textarea>
					  </div>

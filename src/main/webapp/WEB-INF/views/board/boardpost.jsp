...
$(document).on('click', '#replyBtn', function(){
	...
	if(replyContent == "" && email == ""){
		...
		$.ajax({
			url : '/cota/replyPosting1',			// 전송할 URL
			type : 'get',				// 전송 방식
			data : sendData, 							// 전송할 데이터
			success : function() {  // 통신이 성공했다면 수행할 콜백메서드
				location.href = "/cota/postform1?bnum=${board.bnum }";
			}
		});
	}
});
...
$(document).on('click', '#updateBtn', function(){
	location.href = "/cota/boardupdateForm?bnum="+"${board.bnum }";
});                       
...
$(document).on('click', '#deleteBtn', function(){
	bootbox.confirm({
	    ...
	    callback: function (result) {
			if(result == true){
				location.href = "/cota/boarddelete?bnum="+"${board.bnum }";
			}else{                     
				return;
			}
	    }
           ...
           <!-- <div class="row" style="height:15px;"></div> -->
           		...
           		<div class="col-lg-8" id="rowWrapper">
           			<div class="alert alert-success col-lg-12">
						 자유 게시판입니다. 다른 개발자들과 함께 자유롭게 소통해보세요.
					</div>
           			<div class="row">
				...
				<div class="row" style="margin-bottom: 15px;">
					<div class="col-lg-12"  style="height: 40px; border: 1px solid gray; border-top:none;">
						<div class="col-lg-1">
							<button type="button" class="btn btn-primary" onclick="location.href='list1'">목 록</button>
						</div>

...
<script type="text/javascript">
	...
	function emailCheck() {
		if (!findPassword.email.value) {
			...
			return;
		} else if (findPassword.email.value.indexOf('@') < 0
				|| findPassword.email.value.indexOf('.') < 0) {
		...
		$.post('/cota/FindPasswordPro', sendData, function(result) {
...
<!-- Bootstrap Core CSS -->
<link
	href="${pageContext.request.contextPath}/mypage/vendor/bootstrap/css/bootstrap.min.css"
	rel="stylesheet">

<!-- MetisMenu CSS -->
<link
	href="${pageContext.request.contextPath}/mypage/vendor/metisMenu/metisMenu.min.css"
	rel="stylesheet">

<!-- Custom CSS -->
<link
	href="${pageContext.request.contextPath}/mypage/dist/css/sb-admin-2.css"
	rel="stylesheet">

<!-- Custom Fonts -->
<link
	href="${pageContext.request.contextPath}/mypage/vendor/font-awesome/css/font-awesome.min.css"
...
<body>
						...
						<form role="form" action="passwordchange" name="findPassword"
							...
							<fieldset>
								<div class="form-group">
									...
									<div class="view2">
										<button id='emailChkbtn' class="form-control">Email확인</button>
									</div>
									<div class="test1"></div>
	...
	<!-- jQuery -->
	<script
		src="${pageContext.request.contextPath}/mypage/vendor/jquery/jquery.min.js"></script>

	<!-- Bootstrap Core JavaScript -->
	<script
		src="${pageContext.request.contextPath}/mypage/vendor/bootstrap/js/bootstrap.min.js"></script>

	<!-- Metis Menu Plugin JavaScript -->
	<script
		src="${pageContext.request.contextPath}/mypage/vendor/metisMenu/metisMenu.min.js"></script>

	<!-- Custom Theme JavaScript -->
	<script
		src="${pageContext.request.contextPath}/mypage/dist/js/sb-admin-2.js"></script>
